...
methodname = 'Simulated Annealing'
...
for _ in range(nr_of_iterations):
    current_weights = best_weights + noise_scaling * np.random.normal(loc=0, scale=spread, size=4) # Every weight gets its own independent noise value
    episode_history = []
