...
if best_reward >= 400:
    ...
    df_climbing['value'] = np.where(df_climbing['history']<250, 0, 
                                np.where(df_climbing['history']<400, 0.5, 1))
    ...
    ax[0,1].set_axis_off()
    ax[0,1].text(0.1, 0.7, "<250", color="black", transform=ax[0,1].transAxes)
    ax[0,1].text(0.1, 0.8, "250><400", color="orange", transform=ax[0,1].transAxes)
    ax[0,1].text(0.1, 0.9, ">400", color="red", transform=ax[0,1].transAxes)
